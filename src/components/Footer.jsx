        ...
        <footer className="py-5">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-menu">
                                ...
                                <ul className="menu-list list-unstyled">
                                    ...
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Condições </a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Nossos Diários</a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Carreiras</a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Programas Afiliados</a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Imprensa </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-menu">
                                <h5 className="widget-title">Atendimento ao Cliente</h5>
                                <ul className="menu-list list-unstyled">
                                    <li className="menu-item">
                                    ...
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Devoluções e Reembolços</a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">Diretrizes sobre Cookies</a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="#" className="nav-link"> Informaçãoes de Delivery</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="footer-menu">
                                <h5 className="widget-title">Nos siga</h5>
                                <p>Assine nosso boletim informativo para receber atualizações sobre nossas grandes ofertas.</p>
                                <form className="d-flex mt-3 gap-0" role="newsletter">
                                    <input className="form-control rounded-start rounded-0 bg-light" type="email" placeholder="Endereço de Email" aria-label="Endereço de Email"/>
                                        <button className="btn btn-dark rounded-end rounded-0" type="submit">Inscreva-se</button>
                                </form>
                            </div>
                        </div>
